...
public interface IpFilterListener
{
    ...
    */
   public ChannelFuture allowed(ChannelHandlerContext ctx, InetSocketAddress inetSocketAddress);
    ...
    * @return the associated ChannelFuture to be waited for before closing the channel. Null is allowed.
    */
   public ChannelFuture refused(ChannelHandlerContext ctx, InetSocketAddress inetSocketAddress);
    ...
    */
   public boolean continues(ChannelHandlerContext ctx);
